  ...
  def create
    begin
      ...
      if resource.valid_password? params[:user_login][:password]
        ...
        render json: { status: 200, message: 'Successfully logged in', user: {id: resource.id, username: resource.username, email: resource.email, created_at: resource.created_at, updated_at: resource.updated_at, authentication_token: resource.authentication_token }}
      else
